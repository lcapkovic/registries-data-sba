(function(angular) {
	...
	.config(['$translateProvider', function($translateProvider) {
		...
		"menu.search.refereeAssistant.lower.level":"Hľadať asistenta",
		"menu.search.administrativeStaff.lower.level":"Hľadať organ. pracovníka",
		"menu.stadium.title": "Športová hala",
		...
		"schema.people.referee.refereeLicense":"Kvalifikačný stupeň",
		"schema.people.referee.inSeason":"Zaradenie v sezóne",
		...
		"schema.people.referee.feeDate":"Poplatky",
		"schema.people.referee.licenseSeminar":"Licenčný seminár",

		"schema.people.refereeAssistant":"Asistent rozhodcu",
		"schema.people.isRefereeAssistant":"Je asistent rozhodcu",
		"schema.people.refereeAssistant.dateOfRegistration":"Dátum registrácie",
		"schema.people.refereeAssistant.feeDate":"Poplatky",
		"schema.people.referee.licenseSeminar":"Licenčný seminár",
		...
		"schema.people.administrativeStaff":"Organizačný pracovník",
		"schema.people.isAdministrativeStaff":"Je administratívny pracovník",
		"schema.people.club":"Klub",
		"schema.people.extraLiga":"Extra liga",
		"schema.people.1liga":"1. liga",
		"schema.people.junior":"Junior",
		"schema.people.kadet":"Kadet",
		"schema.people.stZiaci":"Starší žiaci",
		"schema.people.ziaci":"Žiaci",
		"schema.people.mlZiaci":"Mladší žiaci",
		"schema.people.stMini":"Starší mini",
		"schema.people.mlMini":"Mladší mini",
		"schema.people.2liga":"2. liga",
		...
		"schema.stadium.title":"Hala",
		"schema.stadium.baseData":"Základné údaje",
		"schema.stadium.name":"Názov haly",
		...
		"schema.org.club.clubAddress":"Klub - poštová adresa",
		...
		"schema.org.club.webPage":"Webové sídlo klubu",
		...
		"schema.org.assoc.associationAddress":"Zväz - poštová adresa",
		...
		"schema.transfer.transferTicket":"Prestupový lístok",
		"schema.transfer.fee":"Poplatok",
		...
		"schema.fees.baseData.feeType":"Účel platby",
		"schema.fees.baseData.paymentMethod":"Spôsob platby",
		...
		"schema.ageCategory.year":"Počet rokov",
